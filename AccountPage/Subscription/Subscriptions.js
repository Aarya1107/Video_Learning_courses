...
export default function Subscriptions() {
  return (
    <>
      <div className={Styles["PersonalPlan-fullPage"]}>
        <div className={Styles["main-container1"]}>
          <div className={Styles["container1"]}>
            <div className={Styles["PersonalPlane-para"]}>Personal Plan</div>
            <div>
          ...
          <div className={Styles["container2"]}>
            <img
              src="/images/subscription_img.jpg"
              alt=""
        ...
        <div className={Styles["main-container1"]}>
          ...
          <div className={Styles["sub-container2"]}>
            <div className={Styles["individual-courses-cart"]}>
              <div className={Styles["buyCourse-heading"]}>
              ...
              <div className={Styles["points-div"]}>
                <div className={Styles["points"]}>
                  <AiOutlineCheck /> 213,000+ professional and personal
                  development courses
                </div>
                <div className={Styles["points"]}>
                  <AiOutlineCheck /> Pay as you go
                </div>
