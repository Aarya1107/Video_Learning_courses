...
import Styles from "./AccNotification.module.css"
export default function AccNotification() {
  ...
  const StudentMessageData = [
    {
      ...
      message: "Keep growing keep learning",
      image: "/image/Baljitsir_image.PNG",
    },
    {
      id: "02",
      senderName: "Balram Pandey",
      message: "Make a schedule for your learning and keep going.",
